...
public class GuiPlayerSoulManipulatorInventory extends GuiContainer {
	
	private TileEntityPlayerSoulManipulator psm;

	public GuiPlayerSoulManipulatorInventory(InventoryPlayer invPlayer, TileEntityPlayerSoulManipulator psm) {
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		mc.renderEngine.bindTexture(LibResource.playerSoulManipulator_1);
