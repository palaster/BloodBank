...
import palaster97.ss.inventories.slots.SlotSCCrafting;
...
public class ContainerSoulCompressor extends Container {
    ...
    @Override
    public boolean canInteractWith(EntityPlayer p_75145_1_) { return worldObj.getBlockState(field_178145_h).getBlock() != SSBlocks.soulCompressor ? false : p_75145_1_.getDistanceSq((double)field_178145_h.getX() + 0.5D, (double)field_178145_h.getY() + 0.5D, (double)field_178145_h.getZ() + 0.5D) <= 64.0D; }
