...
import palaster97.ss.client.renderers.RenderBeaver;
...
public class SSEntities {
	...
	public static void registerEntityRenderers() {
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityBeaver.class, new RenderBeaver(Minecraft.getMinecraft().getRenderManager()));
	}
}
