...
public class KPCurseUnblinkingEye implements IKnowledgePiece {

	@Override
	public String getName() { return "bb.kp.curseUnblinkingEye"; }
	...
	public boolean knowledgePieceInteractionForEntity(ItemStack stack, EntityPlayer playerIn, EntityLivingBase target, EnumHand hand) {
		if(!playerIn.worldObj.isRemote)
			if(target instanceof EntityPlayer) {
				target.addPotionEffect(new PotionEffect(BBPotions.curseUnblinkingEye, 12000, 0, false, true));
				return true;
			}
		return false;
	}
