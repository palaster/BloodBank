...
public class KPCurseBlackTongue implements IKnowledgePiece {

	@Override
	public String getName() { return "bb.kp.curseBlackTongue"; }
	...
	public boolean knowledgePieceInteractionForEntity(ItemStack stack, EntityPlayer playerIn, EntityLivingBase target, EnumHand hand) {
		if(!playerIn.worldObj.isRemote)
			if(target instanceof EntityPlayer) {
				target.addPotionEffect(new PotionEffect(BBPotions.curseBlackTongue, 12000, 0, false, true));
				return true;
			}
		return false;
	}
