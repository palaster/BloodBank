...
public class EntityModAIAttackRangedBow extends EntityAIBase {
    ...
    protected boolean func_188498_f() { return this.entity.getHeldItemMainhand() != null && this.entity.getHeldItemMainhand().getItem() == Items.bow; }

    @Override
    public boolean continueExecuting() { return (this.shouldExecute() || !this.entity.getNavigator().noPath()) && this.func_188498_f(); }
