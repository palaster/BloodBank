...
import palaster.bb.world.task.TaskManager;
...
public class BBWorldSaveData extends WorldSavedData {
    ...
    public BBWorldSaveData(World world) {
    	super(IDENTIFIER);
    	tm = new TaskManager(world);
    }
    ...
    @Nullable
    public TaskManager getTaskManager() { return tm; }
    ...
    public static BBWorldSaveData get(World world) {
        ...
        if(data == null) {
            data = new BBWorldSaveData(world);
